...
public class ProductoHandler {
	 ...
	 * 
	 * @param request recibe los parámetros
	 * @return
	 */
	 ...
	 * 
	 * @param request recibe desde RouterFunctionConfig
	 * @return Mono<ServerResponse>
	 */
	public Mono<ServerResponse> crear(ServerRequest request) {
		// Obtener el producto convertido a Mono
	...
	public Mono<ServerResponse> editar(ServerRequest request) {
		...
		return productoDb.zipWith(producto, (db, req) -> {
			...
			return db;
		}).flatMap(p -> ServerResponse.created(URI.create("/api/v2/productos/".concat(p.getId()))).body(service.save(p),
